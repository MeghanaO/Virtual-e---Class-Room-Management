...
<body>
<form name="EditStudentForm" action="../Controller" method="post">
<center>
...
<tr><td>Contact Number</td><td><input type="text" style="background-color:Burlywood;font_color:black" name="phonenumber" value="" onblur="validateStudentPhoneno()"></td></tr>
