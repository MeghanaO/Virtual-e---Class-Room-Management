<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.tcs.bean.Student, com.tcs.bean.QuestionAndAnswer"%>
...
<div id="header" style="background-color: Lemonchiffon;">
	...
	<%ArrayList<QuestionAndAnswer> qalist= (ArrayList<QuestionAndAnswer>)session.getAttribute("List1");
	if(qalist.size()>0){ %>
	<table>
	<tr>
	<td>ClassRoomID</td>
